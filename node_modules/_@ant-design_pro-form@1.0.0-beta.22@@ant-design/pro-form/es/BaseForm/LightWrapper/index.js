...
var LightWrapper = function LightWrapper(props, ref) {
  ...
  if (!light || customLightMode) {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, React.isValidElement(children) ? React.cloneElement(children, _objectSpread(_objectSpread({
      ref: ref
    }, children.props), {}, {
  ...
  return /*#__PURE__*/React.createElement(FieldDropdown, {
    disabled: disabled,
    ...
    style: style
  }, React.isValidElement(children) ? React.cloneElement(children, _objectSpread(_objectSpread({
    ref: ref
  }, children.props), {}, {
