...
var StepsForm = function StepsForm(props) {
  ...
  var regForm = useCallback(function (name, formProps) {
  ...
  var onFormFinish = useCallback(function (name, formData) {
  ...
  var stepsDom = /*#__PURE__*/React.createElement(_Steps, _extends({
    size: "small"
  }, stepsProps, {
    current: step,
    onChange: undefined
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: prefixCls
  }, /*#__PURE__*/React.createElement(_Form.Provider, rest, props.renderSteps ? props.renderSteps(formArray.map(function (item) {
  ...
  }), stepsDom) : stepsDom, /*#__PURE__*/React.createElement(StepsFormProvide.Provider, {
    value: {
      keyArray: formArray,
      next: function next() {
  ...
  }, toArray(props.children).map(function (item, index) {
    var itemProps = item.props;
    var name = itemProps.name || "".concat(index);
    regForm(name, itemProps);
    return /*#__PURE__*/React.createElement("div", {
      className: classNames("".concat(prefixCls, "-step"), _defineProperty({}, "".concat(prefixCls, "-step-active"), step === index)),
      key: name
    }, React.cloneElement(item, _objectSpread(_objectSpread({}, itemProps), {}, {
      name: name,
      step: index,
      key: name
    })));
