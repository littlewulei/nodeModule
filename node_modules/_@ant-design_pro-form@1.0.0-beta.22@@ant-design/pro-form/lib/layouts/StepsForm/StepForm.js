...
var StepForm = function StepForm(_ref) {
  ...
  var next = /*#__PURE__*/_react.default.createElement(_button.default, {
    key: "next",
    type: "primary",
    loading: loading,
  ...
  var pre = /*#__PURE__*/_react.default.createElement(_button.default, {
    key: "pre",
    onClick: function onClick() {
      context === null || context === void 0 ? void 0 : context.pre();
    }
  }, "\u4E0A\u4E00\u6B65");

  var submit = /*#__PURE__*/_react.default.createElement(_button.default, {
    key: "submit",
    type: "primary",
  ...
  var propsSubmitter = isBoolean(restProps.submitter) ? {} : restProps.submitter;
  ...
  var getActionButton = function getActionButton() {
    ...
    if (index + 1 === (context === null || context === void 0 ? void 0 : context.keyArray.length)) {
      return [pre, submit];
    }
  ...
  return /*#__PURE__*/_react.default.createElement(_BaseForm.default, _extends({
    ...
    submitter: restProps.submitter === false ? false : _objectSpread(_objectSpread({}, propsSubmitter || {}), {}, {
      // 反转按钮，在正常模式下，按钮应该是主按钮在前
      render: function render(submitterProps) {
        var dom = getActionButton();

        var _ref5 = propsSubmitter || {},
            render = _ref5.render;
