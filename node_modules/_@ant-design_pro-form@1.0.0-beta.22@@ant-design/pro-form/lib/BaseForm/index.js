...
function createField(Field, config) {
  var FieldWithContext = function FieldWithContext(props) {
    ...
    var label = props.label,
        ...
        rest = _objectWithoutProperties(props, ["label", "tip", "placeholder", "proFieldProps", "bordered"]);
    ...
    var realFieldProps = _objectSpread(_objectSpread({
...
var BaseForm = function BaseForm(props) {
  ...
  return (
    ...
    _react.default.createElement(_proProvider.ConfigProviderWarp, null, /*#__PURE__*/_react.default.createElement(_FieldContext.default.Provider, {
      value: {
