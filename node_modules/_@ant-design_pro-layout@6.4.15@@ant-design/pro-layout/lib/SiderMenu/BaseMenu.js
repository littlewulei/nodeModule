...
var BaseMenu = function BaseMenu(props) {
  ...
  var postMenuDataRef = (0, _react.useRef)(postMenuData);
  ...
  (0, _react.useEffect)(function () {
    ...
    var keys = (0, _SiderMenuUtils.getSelectedMenuKeys)(location.pathname || '/', postMenuDataRef.current || []);
  ...
  var _useState5 = (0, _react.useState)(function () {
    return new MenuUtil(props);
      ...
      menuUtils = _useState6[0]; // sync props
  ...
  (0, _react.useEffect)(function () {
    if (splitMenus && openKeys) {
      ...
      if (key) {
        ...
        var postData = (menuData === null || menuData === void 0 ? void 0 : (_menuData$find = menuData.find(function (item) {
          return item.key === key;
        })) === null || _menuData$find === void 0 ? void 0 : _menuData$find.children) || [];
