...
var conversionProProSchemaToDescriptionsItem = function conversionProProSchemaToDescriptionsItem(items, entity, action) {
  ...
  var children = items.map(function (item, index) {
    ...
    var valueType = typeof restItem.valueType === 'function' ? restItem.valueType(entity || {}) : restItem.valueType;
    ...
    var field = /*#__PURE__*/_react.default.createElement(_descriptions.default.Item, _extends({}, restItem, {
      ...
      render ? function (_, props, dom) {
        return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, render(dom, entity, index, action, _objectSpread(_objectSpread({}, item), props)));
      } : undefined,
      valueType: valueType,
      plain: plain,
      text: text,
...
var ProDescriptions = function ProDescriptions(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_descriptions.default, _extends({}, rest, {
