 ...
 */
export declare type ProFieldValueType = 'money' | 'textarea' | 'option' | 'date' | 'dateWeek' | 'dateRange' | 'dateTimeRange' | 'dateTime' | 'time' | 'text' | 'index' | 'indexBorder' | 'progress' | 'percent' | 'digit' | 'avatar' | 'code' | 'jsonCode';
...
declare const _default: React.ForwardRefRenderFunction<any, {
    ...
    valueType?: "text" | "code" | "option" | "progress" | "textarea" | "time" | "percent" | "date" | "dateTime" | "money" | ProFieldValueObjectType | "dateWeek" | "dateRange" | "dateTimeRange" | "index" | "indexBorder" | "digit" | "avatar" | "jsonCode" | undefined;
