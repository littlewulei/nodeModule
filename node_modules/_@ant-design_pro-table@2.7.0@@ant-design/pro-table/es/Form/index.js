...
import ProForm, { QueryFilter, ProFormField } from '@ant-design/pro-form';
import classNames from 'classnames';
import { ConfigContext } from 'antd/lib/config-provider/context';
import { useDeepCompareEffect, conversionSubmitValue } from '@ant-design/pro-utils';
...
export var formInputRender = function formInputRender(props, ref) {
  ...
  return /*#__PURE__*/React.createElement(ProFormField, _extends({
    ...
    ,
    valueType: !valueType || ['textarea', 'jsonCode', 'code'].includes(valueType) && type === 'table' ? 'text' : valueType,
    initialValue: item.initialValue
  }, rest, {
...
export var proFormItemRender = function proFormItemRender(_ref2) {
  ...
  var valueType = item.valueType,
      ...
      rest = _objectWithoutProperties(item, ["valueType", "dataIndex", "valueEnum", "renderFormItem", "render", "hideInForm", "hideInSearch", "hideInTable", "renderText", "order", "width", "sorter", "formItemProps", "initialValue", "ellipsis", "index", "filters"]); // 支持 function 的 title
...
var FormSearch = function FormSearch(_ref3) {
  ...
  var valueTypeRef = useRef({}); // 这么做是为了在用户修改了输入的时候触发一下子节点的render
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              if (onSubmit) {
                onSubmit(conversionSubmitValue(value, dateFormatter, valueTypeRef.current));
              }
            ...
            case 7:
              ...
              if (onSubmit) {
                onSubmit(conversionSubmitValue(_value, dateFormatter, valueTypeRef.current));
              }
  ...
  useDeepCompareEffect(function () {
    ...
    counter.proColumns.forEach(function (item) {
      var key = item.key,
          dataIndex = item.dataIndex,
          index = item.index,
          valueType = item.valueType; // 以key为主,理论上key唯一

      var finalKey = genColumnKey(key || dataIndex, index); // 如果是() => ValueType

      var finalValueType = typeof valueType === 'function' ? valueType(item) : valueType;
  ...
  var FormCompetent = isForm ? ProForm : QueryFilter;
  return /*#__PURE__*/React.createElement("div", {
    className: classNames(className, _defineProperty({}, formClassName, isForm))
  }, /*#__PURE__*/React.createElement(FormCompetent, _extends({
