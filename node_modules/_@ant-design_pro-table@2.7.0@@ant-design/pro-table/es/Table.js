...
import { useDeepCompareEffect, LabelIconTip, pickUndefinedAndArray, pickUndefined } from '@ant-design/pro-utils';
...
var ProTable = function ProTable(props) {
  ...
  var action = useFetchData( /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(pageParams) {
      var needManualFirstReq, actionParams, response, responseData, msgData;
  ...
  var tableDom = /*#__PURE__*/React.createElement(_Table, _extends({}, rest, {
    ...
    onChange: function onChange(changePagination, filters, sorter, extra) {
      ...
      setProFilter(pickUndefinedAndArray(filters)); // 制造一个排序的数据
      ...
      if (Array.isArray(sorter)) {
        ...
        setProSort(pickUndefined(data));
      } else {
        setProSort(pickUndefined(_defineProperty({}, "".concat(sorter.field), sorter.order)));
      }
    }
  }));
  /**
  ...
  return /*#__PURE__*/React.createElement(_ConfigProvider, {
    ...
    style: style,
    ref: rootRef
  }, (search !== false || type === 'form') && /*#__PURE__*/React.createElement(FormSearch, _extends({}, rest, {
    type: type,
    formRef: formRef,
