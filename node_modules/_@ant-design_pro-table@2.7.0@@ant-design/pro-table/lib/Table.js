...
var genColumnList = function genColumnList(columns, map, counter, columnEmptyText) {
  return columns.map(function (item, columnsIndex) {
    ...
    return (0, _proUtils.pickUndefinedAndArray)(tempColumns);
...
var ProTable = function ProTable(props) {
  ...
  var tableDom = /*#__PURE__*/_react.default.createElement(_table.default, _extends({}, rest, {
    ...
    onChange: function onChange(changePagination, filters, sorter, extra) {
      ...
      setProFilter((0, _proUtils.pickUndefinedAndArray)(filters)); // 制造一个排序的数据
      ...
      if (Array.isArray(sorter)) {
        ...
        setProSort((0, _proUtils.pickUndefined)(data));
      } else {
        setProSort((0, _proUtils.pickUndefined)(_defineProperty({}, "".concat(sorter.field), sorter.order)));
      }
    }
  }));
  /**
  ...
  return /*#__PURE__*/_react.default.createElement(_configProvider.default, {
    ...
    style: style,
    ref: rootRef
  }, (search !== false || type === 'form') && /*#__PURE__*/_react.default.createElement(_Form.default, _extends({}, rest, {
    type: type,
    formRef: formRef,
